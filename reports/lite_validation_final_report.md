# Rapport — 2026-03-22 16:12

## Parametres de validation
- IS (In-Sample): 20230101-20251130 (~35 mois — hyperopt)
- OOS (Out-of-Sample): 20251201-20260319 (3.5 mois — validation)
- Min trades OOS: 20

## Benchmark Buy & Hold (OOS)
- Rendement moyen (equal weight): **-22.59%**
  - BTC/USDT: -17.52%
  - ETH/USDT: -21.71%
  - SOL/USDT: -28.53%
...
|-----------|------------|-----------|----------------|--------|
| EMATripleCrossLite | 4.73 | -2.01 | 1.75 | **ROBUSTE** |
| RSIDivergenceLite | -3.05 | -0.85 | 0.85 | **ROBUSTE** |